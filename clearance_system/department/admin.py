...
from department.models import Department, Items, StudentItems, StudentCourse, Course, Report
...
class DepartmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ('Item Information:', {
         'fields': ('dept_name', 'dept_hod', 'is_academic',)}),
    )
...
class StudentItemsAdmin(admin.ModelAdmin):
    ...
    list_display = ['student_item', 'student',
                    'borrow_date', 'return_date', 'quantity']
    ...
    fieldsets = (
        ('Item Information:', {'fields': (
            'student_item', 'student', 'return_date', 'quantity',)}),
    )
...
class ReportAdmin(admin.ModelAdmin):
    ...
    list_display = ['user', 'message', 'email', 'created_at']
    list_display_links = ['user', 'message', 'email']
    list_filter = ['user']
    ordering = ('created_at',)

    fieldsets = (
        ('Item Information:', {'fields': ('user', 'message', 'email',)}),
    )
